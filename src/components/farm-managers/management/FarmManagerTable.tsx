...
interface FarmManagerTableProps {
  activeTab: string;
  filteredData: FarmManager[] | PendingApproval[];
  handleViewProfile: (operator: FarmManager) => void;
  ...
  handleEdit: (operator: FarmManager) => void;
...
const FarmManagerTable: React.FC<FarmManagerTableProps> = ({
  activeTab,
  filteredData,
  handleViewProfile,
    ...
    <CustomTable>
      <table className="w-full">
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {activeTab === 'all' ? (
            (filteredData as FarmManager[]).map((operator) => (
...
export default FarmManagerTable;
